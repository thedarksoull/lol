...
const commands = {
  ...
  avatar: function(target, room, user) {
    ...
    let avatarTable = {
      ...
      prince: "#prince",
      mjb: "#mjb",
      litteleven: "#litteleven",
      kris: "#kris",
      kaijubunny: "#kaijubunny",
      instruct: "#instruct",
      flare: "#flare",
      dontlose: "#dontlose",
      aethernum: "#aethernum",
      lilburr: "#lilburr",
      silver: "#silver",
      splxcooters: "#splxcooters",
      splxtyrants: "#splxtyrants",
      solganstpuid: "#snowydoe",
      spy: "#spy",
      talah: "#talah",
      teampokepals: "#teampokepals",
      teclis: "#teclis",
      onlyaxel: "#redemption",
      vextal: "#vextal",
      wcop2019asia: "#wcop2019asia",
      wcop2019canada: "#wcop2019canada",
      wcop2019greece: "#wcop2019greece",
      wcop2019uswest: "#wcop2019uswest",
      wcop2020france: "#wcop2020france",
      yagura: "#yagura",
      yashgreninja: "#yashgreninja",
      crushindefeat: "#crushindefeat",
      deaglem40: "#deaglem40",
      epicnikolai: "#epicnikolai",
      ridaz: "#ridaz",
      sinon: "#alpha",
      briayan: "#briayan",
      Fcl8kystriker: "#Fcl8skystriker",
      articuno: "#articuno",
      eyan: "#eyan",
      wcop2020ussouth: "#wcop2020ussouth",
      nol: "#nol",
       nerd: "#nerd"
    };
  ...
  forcelol: "lol",
  lol: "lol",
  lol: function(target, room, user, connection, cmd) {
