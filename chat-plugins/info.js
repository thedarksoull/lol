...
const commands = {
  ...
  "!tourney": true,
  tourney: function(target, room, user) {
    if (!this.runBroadcast()) return;
    this.sendReplyBox(
      `<center>Gen 7 Tours </center><center> <button class="button" name="send" value="/tour create /random battle,elimination"><b>Random</b> </button><button class="button" name="send" value="/tour create /gen 7 bss factory,elimination"><b>Bss</b> </button><button class="button" name="send" value="/tour create /1v1,elimination"><b>1v1</b> </button><button class="button" name="send" value="/tour create /super staff bros brawl,elimination"><b>Ssb</b> </button> <button class="button" name="send" value="/tour create /gen 7 ou,elimination"><b>Ou</b> </button> <button class="button" name="send" value="/tour create /gen 7 ubers,elimination"><b>Ubers</b> </button></center><center>Tour controls</center><center><button class="button" name="send" value="/tour autodq 1"><b>Auto Disqualify</b> </button><button class="button" name="send" value="/tour autostart 1"><b>Auto Start 1</b> </button><button class="button" name="send" value="/tour autostart 5"><b>Auto Start 5</b> </button><button class="button" name="send" value="/tour end"><b>End Tour</b> </button><button class="button" name="send" value="/tour start"><b>Start Tour</b> </button></center>`
    );
  },
